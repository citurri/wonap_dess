...
public class TouristAttractions {
    ...
    private static final float TRIGGER_RADIUS = 100; // 2KM
    ...
    public static final Map<String, LatLng> CITY_LOCATIONS = new HashMap<String, LatLng>() {{
        put(CITY_SYDNEY, new LatLng(-17.680078865138313,-63.14334273638917));
    }};
    ...
    public static HashMap<String, List<Attraction>> getAttractions() {
    ...
    HashMap<String, List<Attraction>> ATTRACTIONS =
        ...
        put(CITY_SYDNEY, new ArrayList<Attraction>() {{
            add(new Attraction(
                    ...
                    new LatLng(-17.680078865138313, -63.14334273638917),
                    CITY_SYDNEY
            ));
